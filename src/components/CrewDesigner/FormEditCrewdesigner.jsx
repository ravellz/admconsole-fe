...
const FormEditCrewDesigner = () => {
  ...
  const getCrewDesignerById = async () => {
    try {
  ...
  const updateCrewdesigner = async (e) => {
    e.preventDefault();
    try {
      await axios.patch(`${API_BASE_URL}/crewdesigner/${id}`, {
        name: name,
        title: title
      });
  ...
  return (
    <div className="columns ml-3 mt-5">
      <div className="column is-half">
        <form onSubmit={updateCrewdesigner}>
          <div className="field">
...
export default FormEditCrewDesigner;
