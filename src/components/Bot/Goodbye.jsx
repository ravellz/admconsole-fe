...
const Goodbye = () => {
  ...
  const [goodbyeChannels, setGoodbyeChannels] = useState([]);
  ...
  useEffect(() => {
    ...
    const goodbyeChannelsData =
      dataChannels && dataChannels.goodbyeChannels
        ? dataChannels.goodbyeChannels
        : [];
    setGoodbyeChannels(goodbyeChannelsData);
  }, []);
  ...
  const saveChannelsToServer = async (enabledValue) => {
    ...
    await axios.post(`${API_BASE_URL}/saveGoodbyeChannels`, {
      goodbyeChannels: channelsToSave,
    });
  };
    ...
    <div className="container-log">
      <div className="box has-text-centered">
        <div className="column">
          <label className="label">Goodbye Log</label>
          <div className="field">
            <button
          ...
          <div className="field">
            <div className="box">
              <div className="field">
                ...
                <ul>
                  {goodbyeChannels.map((channel, index) => (
                    <li key={index}>
