...
const Avatar = () => {
  ...
  const [avatarChannels, setAvatarChannels] = useState([]);
  ...
  useEffect(() => {
    ...
    const avatarChannelsData =
      dataChannels && dataChannels.avatarChannels
        ? dataChannels.avatarChannels
        : [];
    setAvatarChannels(avatarChannelsData);
  }, []);
  ...
  const saveChannelsToServer = async (enabledValue) => {
    ...
    await axios.post(`${API_BASE_URL}/saveAvatarChannels`, {
      avatarChannels: channelsToSave,
    });
  };
    ...
    <div className="container-log">
      <div className="box has-text-centered">
        <div className="column">
          <label className="label">Avatar Log</label>
          <div className="field">
            <button
          ...
          <div className="field">
            <div className="box">
              <div className="field">
                ...
                <ul>
                  {avatarChannels.map((channel, index) => (
                    <li key={index}>
