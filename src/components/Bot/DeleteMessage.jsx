...
const DeleteMessage = () => {
  ...
  const [deleteMessageChannels, setDeleteMessageChannels] = useState([]);
  ...
  useEffect(() => {
    ...
    const deleteMessageChannelsData = dataChannels && dataChannels.deleteMessageChannels ? dataChannels.deleteMessageChannels : [];
    setDeleteMessageChannels(deleteMessageChannelsData);
  }, []);
  ...
  const saveChannelsToServer = async (enabledValue) => {
    ...
    await axios.post(`${API_BASE_URL}/saveDeleteMessageChannels`, { deleteMessageChannels: channelsToSave });
  };
    ...
    <div className="container-log">
      <div className="box has-text-centered">
        <div className="column">
          <label className="label">Delete Message Log</label>
          <div className="field">
            <button
          ...
          <div className="field">
            <div className="box">
              <div className="field">
                ...
                <ul>
                {deleteMessageChannels.map((channel, index) => (
                <li key={index}>
