...
const RoleLog = () => {
  ...
  const [roleLogChannels, setRoleLogChannels] = useState([]);
  ...
  useEffect(() => {
    ...
    const roleLogChannelsData = dataChannels && dataChannels.roleLogChannels ? dataChannels.roleLogChannels : [];
    setRoleLogChannels(roleLogChannelsData);
  }, []);
  ...
  const saveChannelsToServer = async (enabledValue) => {
    ...
    await axios.post(`${API_BASE_URL}/saveRoleChannels`, { roleLogChannels: channelsToSave });
  };
    ...
    <div className="container-log">
      <div className="box has-text-centered">
        <div className="column">
          <label className="label">Role Log</label>
          <div className="field">
            <button
          ...
          <div className="field">
            <div className="box">
              <div className="field">
                ...
                <ul>
                {roleLogChannels.map((channel, index) => (
                <li key={index}>
